...
(**aframe-babia-components**, directory, exported 2026-07-29T15:22:35.854Z).
...
- **Historical comparison**: fully interactive across the exported revisions. Offline comparisons: pick any two of the 36 exported sources.
- **Project evolution**: create and play movies from the exported revisions. Offline movies from the 36 exported sources (Auto, Range or Manual).
