...
(**JetUML**, directory, exported 2026-07-29T15:13:50.814Z).
...
- **Historical comparison**: fully interactive across the exported revisions. Offline comparisons: pick any two of the 35 exported sources.
- **Project evolution**: create and play movies from the exported revisions. Offline movies from the 35 exported sources (Auto, Range or Manual).
